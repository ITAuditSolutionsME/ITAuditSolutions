    ...
    public static void main(String[] args) {
        ...
        for (File sourceFile : sourceFiles) {
            if (sourceFile.isFile()) {
                ...
                //Die varible id beginnt bei 1 und jedes mal wenn eine Zeile mit F kommt wird dieser um 1 erhöht.
                //Alle anderen Zeilen zwischen zwei F`s bekommen die ID, des letzten verherigen F`s
